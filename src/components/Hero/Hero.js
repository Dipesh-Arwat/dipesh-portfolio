...
import Myself from '../../assets/images/myself2.jpg';
      ...
      <div className="hero">
        <div className="hero__container">
          <div className="hero__intro-box">
            ...
            >
              <p>
                I'm a Motivated and dedicated{' '}
                <span>Full Stack Developer</span> eager to enhance skills and contribute to a dynamic team. Committed to delivering quality code and
                continuously learning new technologies. Excited to make a meaningful impact in software development.
              </p>
            </div>
